...
// stylus 模版
const stylusTep = `@import "../../assets/stylus/variables.styl";
...
const getters: GetterTree<${capPirName}State, any> = {
  ${dirName}author: (state: ${capPirName}State) => state.${dirName}.${dirName}author
};
...
fs.writeFileSync(`${dirName}.styl`, stylusTep); // stylus
